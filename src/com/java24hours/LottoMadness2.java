...
public class LottoMadness2 extends JFrame{
    //Set up Row 1
    JPanel row1 = new JPanel();
    ButtonGroup option = new ButtonGroup();
    String[] picks = {"Quick Pick", "Personal"};
    JComboBox pickBox = new JComboBox<>(picks);
    ...
    public static void main(String[] args) {
        LottoMadness2.setLookAndFeel();
        LottoMadness2 frame = new LottoMadness2();
    }
}
